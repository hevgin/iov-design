...
分步引导用户完成复杂流程的导航组件，适用于表单提交、流程审批、设置向导等场景，步骤数量最少为 2 步。
...
`description` 为每个步骤补充说明文字，让流程更清晰，适用于步骤逻辑较复杂的业务场景。
...
开启 `align-center` 让标题和描述居中对齐，适配居中布局的页面设计。
...
设置 `direction="vertical"` 启用垂直布局，适用于侧边栏、高度受限的页面场景。
